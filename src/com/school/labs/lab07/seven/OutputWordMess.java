...
public class OutputWordMess {
    ...
    public static void main(String args[]) {
        ...
        Vector<String> noSameWord;

        WordStatistic statistic = new WordStatistic();

        statistic.setFileName("src/com/school/labs/lab07/seven/hello.txt");
        ...
        for (int m = 0; m < noSameWord.size(); m++) {
            ...
            for (int n = m + 1; n < noSameWord.size(); n++) {
                ...
                if (count[n] > count[m]) {
                    ...
                    noSameWord.setElementAt(
                            noSameWord.elementAt(n),
                            m
                    );
